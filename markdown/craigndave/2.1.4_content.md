...
- Universal Serial Bus (USB) is a serial method of transmitting data. It has become the most common type of input/output used in computing and an industry-standard method of transferring data between devices.
