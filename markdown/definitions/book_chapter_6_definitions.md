...
a powerful computer system programmed to monitor and control a complex process without the need for human interaction
...
## accelerometer
a sensor that measures acceleration and deceleration and that can detect, for example, the orientation of a device
...
## end-effector
an attachment to a robot arm that allows it to carry out a specific task, such as spray painting
...
a collection of rules and data which gives a computer system the ability to reason, learn and adapt to external stimuli
