...
#### Binary Addition
**Add two binary numbers and show the result** (3 marks)
- Add bits from right to left
- Carry over values when sum exceeds 1
- Show all carries in working
- State final result

**Add two hexadecimal numbers and explain overflow if it occurs** (3 marks)
- Perform hexadecimal addition
- Overflow occurs when digit exceeds F (15)
- Carry over excess to next column
- State whether overflow has occurred

#### Two's Complement
**Represent a negative number using two's complement** (2 marks)
- Invert all bits (change 0s to 1s and 1s to 0s)
- Add 1 to the result
- Discard any overflow bit

#### Logical Shifts
**Perform a logical left shift on a binary number** (3 marks)
...
**Calculate the file size of an image given resolution and colour depth** (2 marks)
- File size = resolution × colour depth
- Resolution = width × height in pixels
- Colour depth = bits per pixel

**Determine the colour depth needed for a given number of colours** (2 marks)
...
**Calculate the file size of a sound recording given sample rate and duration** (3 marks)
...
#### Data Compression
**Explain the difference between lossy and lossless compression** (3 marks)
...
#### Packet Switching
**Identify the purpose of a packet header** (1 mark)
- Header: contains source/destination addresses, sequence numbers, error control information

**Identify the purpose of a packet trailer** (1 mark)
- Trailer: contains error-checking data (e.g., checksum) to detect transmission errors

#### Data Transmission Methods
**Determine whether data transmission is serial or parallel based on characteristics** (4 marks)
...
**State one advantage of serial transmission over parallel transmission** (2 marks)
- Serial: suitable for long distances, less interference, fewer wires/cables
- Parallel: faster for short distances but suffers from crosstalk over long distances

#### USB Interface
**State two advantages of USB compared to other interfaces** (3 marks)
...
**Describe the features of USB that make it suitable for connecting devices** (3 marks)
...
#### Parity Check
**Determine if a byte has been transmitted correctly using odd parity** (3 marks)
...
#### Checksum
**State what a checksum is used for in data transmission** (2 marks)
...
**Describe how Automatic Repeat Query (ARQ) handles transmission errors** (3 marks)
...
#### Check Digit
**Calculate a check digit for an ISBN number** (4 marks)
...
#### Echo Check
**Describe how echo check detects errors in data transmission** (4 marks)
- Data is sent to receiver
- Receiver sends data back (echo)
- Sender compares original data with echoed data
- If differences found, error detected
- Sender requests retransmission

### 2.3 Encryption

#### Symmetric Encryption
**Explain how symmetric encryption works and give one advantage** (3 marks)
...
**Explain how asymmetric encryption uses public and private keys** (3 marks)
...
**Identify two components of the Von Neumann architecture** (2 marks)
- ALU (Arithmetic Logic Unit), CU (Control Unit), registers, main memory, buses

**State the purpose of the accumulator in the ALU** (1 mark)
- Accumulator: stores intermediate results of calculations performed by ALU

**Identify three registers in the CPU and state their purpose** (2 marks)
...
1. Fetch: instruction copied from memory address in PC to CIR; PC incremented
2. Decode: CU interprets instruction in CIR; determines operation needed
3. Execute: ALU performs calculation OR data transferred between registers/memory

#### CPU Performance Factors
**Explain how cache memory improves CPU performance** (4 marks)
- Cache: fast memory close to CPU; stores frequently accessed instructions/data
- Reduces time to fetch from main memory
- Cores: multiple cores allow parallel processing; each core executes independently
- Clock speed: rate at which CPU processes instructions (Hz); higher speed = faster processing

**Explain how each of the following affects CPU performance: cores, cache, clock speed** (4 marks)
...
#### Embedded Systems
**State what is meant by an embedded system** (2 marks)
...
#### Input Devices
**State what a barcode scanner does when reading a product** (2 marks)
- Uses light sensor to read reflected light pattern
- Decodes into numerical data

#### Sensors
**Describe how a temperature sensor works in an automated system** (3 marks)
- Converts temperature to electrical signal (analog or digital)
- Uses thermistor or thermocouple principles
- Analog: continuous voltage varies with temperature
- Digital: discrete values output to computer

**Describe how three different types of sensors work in automated systems** (4 marks)
...
#### Output Devices
**Compare inkjet and laser printers in terms of how they produce images** (4 marks)
...
#### Actuators
**Explain how an actuator converts electrical signals into physical movement** (4 marks)
...
**State what is meant by volatile memory** (1 mark)
- Contents lost when power is removed

#### Secondary Storage
**Describe two characteristics of magnetic secondary storage** (3 marks)
...
#### Virtual Memory
**Explain how virtual memory allows a computer to run programs larger than RAM** (4 marks)
...
#### IP Address
**Explain the difference between IPv4 and IPv6 addresses** (4 marks)
...
**Identify two application software programs from given examples** (2 marks)
- Programs that perform specific tasks for users
- Examples: word processor, web browser, spreadsheet, games

**Identify two functions of an operating system from given examples** (2 marks)
- Examples: Windows, macOS, Linux
- Functions: user interface, memory management, file management, process management

#### Operating System Functions
**Describe two functions of an operating system** (4 marks)
...
**Describe how an operating system manages files and folders** (4 marks)
- Creating, deleting, renaming, moving files and folders
- Maintaining directory structure
- Folder hierarchy: organised in tree structure; path names locate files; access permissions

#### Interrupts
**Explain what happens when an interrupt is generated** (2 marks)
...
**Explain how interrupts are handled by the operating system** (4 marks)
...
**Identify whether a given translator is a compiler or interpreter** (2 marks)
...
**Compare the operation of a compiler and an interpreter** (4 marks)
...
#### IDE Functions
**Describe two functions of an Integrated Development Environment (IDE)** (4 marks)
...
#### Assembly Language
**State what assembly language is and why it is used** (3 marks)
...
**Explain two advantages of writing programs in high-level languages rather than machine code** (3 marks)
- Easier to read/write; portable across different hardware; abstraction from hardware details
...
#### HTTP and HTTPS
**State what HTTPS stands for** (1 mark)
- HyperText Transfer Protocol Secure

**Explain why HTTPS is more secure than HTTP** (2 marks)
...
#### Cookies
**State what a cookie is and give one use** (3 marks)
...
**Explain the difference between session cookies and persistent cookies** (3 marks)
...
**Explain how cookies are used to remember user preferences on a website** (3 marks)
...
#### URL
**State what each part of a URL represents (protocol, domain, path)** (2 marks)
- Protocol: http:// or https://
- Domain name: identifies website server
- Path: location of specific page/file on server

#### Web Browser Functions
**Describe how a web browser retrieves and displays a web page** (3 marks)
...
**Identify two types of malware from given descriptions** (2 marks)
- Software designed to damage or disrupt (viruses, worms, trojans, ransomware)
- Phishing: fraudulent emails/messages attempting to steal personal information

**Describe two cyber security threats and explain how each can be prevented** (4 marks)
...
#### Social Engineering
**Explain what phishing is and describe how it can be prevented** (3 marks)
- Persuading victims to reveal confidential information
- Prevention: user education, verifying sender, not clicking unknown links, checking URLs carefully

#### Security Solutions
**Describe two security measures that protect data on a computer system** (4 marks)
...
**Evaluate the effectiveness of different security measures for protecting data** (4 marks - AO3)
- Effectiveness criteria: cost, ease of use, level of protection, maintenance required
...
#### Automated Systems
**State what is meant by an automated system** (2 marks)
...
**State what is meant by a sensor in an automated system** (2 marks)
- Device that detects changes in physical conditions (temperature, light, sound)
- Converts physical input to electrical signals for computer processing

#### Sensors and Actuators
**Describe how sensors and actuators work together in an automated system** (4 marks)
...
#### Robot Components
**Describe three components of a robot and their functions** (4 marks)
...
#### AI Characteristics
**Explain how an expert system uses rules and reasoning to make decisions** (3 marks)
...
#### Machine Learning
**Explain the difference between traditional programming and machine learning** (3 marks)
...
#### Expert Systems
**Evaluate the use of expert systems compared to human experts in making decisions** (4 marks - AO3)
